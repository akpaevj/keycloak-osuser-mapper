Преобразование значения атрибута userPrincipalName из профиля пользователя в формат OSUser и добавление атрибута в токены (AccessToken и IDToken) аутентификации.  
