Преобразование значения атрибута userPrincipalName из профиля пользователя в формат OSUser и добавленеи атрибута в токены (AccessToken и IDToken) аутентификации.
